...
| 3 | GPIO 2 | **SDA** (I2C) | INA219 SDA, DS3231 SDA | I2C Data Bus |
| 5 | GPIO 3 | **SCL** (I2C) | INA219 SCL, DS3231 SCL | I2C Clock |
| 6 | GND | Ground | All GNDs | Common Ground |
| 9 | GND | Ground | Button GND | |
| 39 | GND | Ground | | |
| 5V | 5V | 5V Power | Fan (Optional) | |
...
- **0x40**: INA219 (Solar Input) - Default
- **0x41**: INA219 (System Load) - **REQUIRES SOLDERING** Bridge A0 on the board.
